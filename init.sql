...
-- SEED DATA
-- ============================================================
SELECT create_platform('mlops');
SELECT add_org('mlops', 'cloudangles');
SELECT add_org('mlops', 'Dharma Productions');

SELECT add_role('mlops', 'cloudangles', 'admin', true, false);
SELECT add_role('mlops', 'cloudangles', 'data-engineering', false, true);
SELECT add_role('mlops', 'Dharma Productions', 'admin', true, false);
...
SELECT set_perm('mlops', 'cloudangles', 'admin', 'monitoring', true, false, false);

SELECT set_perm('mlops', 'cloudangles', 'data-engineering', 'projects', true, true, true);
SELECT set_perm('mlops', 'cloudangles', 'data-engineering', 'pipelines', true, true, true);
SELECT set_perm('mlops', 'cloudangles', 'data-engineering', 'experiments', true, false, false);
SELECT set_perm('mlops', 'cloudangles', 'data-engineering', 'modelhub', true, false, false);
SELECT set_perm('mlops', 'cloudangles', 'data-engineering', 'serving', true, true, false);
SELECT set_perm('mlops', 'cloudangles', 'data-engineering', 'monitoring', true, false, false);

SELECT set_perm('mlops', 'Dharma Productions', 'admin', 'projects', true, true, true);
SELECT set_perm('mlops', 'Dharma Productions', 'admin', 'pipelines', false, false, false);
SELECT set_perm('mlops', 'Dharma Productions', 'admin', 'experiments', true, true, true);
SELECT set_perm('mlops', 'Dharma Productions', 'admin', 'modelhub', true, true, true);
SELECT set_perm('mlops', 'Dharma Productions', 'admin', 'serving', true, true, true);
SELECT set_perm('mlops', 'Dharma Productions', 'admin', 'monitoring', false, false, false);

SELECT add_user('mlops', 'cloudangles', 'jyothsna.pendyala@cloudangles.com', 'admin', '1d94aa2b-6ea5-4816-af4b-ab5560ff0eeb', true);
SELECT add_user('mlops', 'cloudangles', 'salman_khan@cloudangles.com', 'data-engineering', 'secure-uid-123', false);
SELECT add_user('mlops', 'Dharma Productions', 'karan-johar@dharma.com', 'admin', 'dharma-uid-456', true);